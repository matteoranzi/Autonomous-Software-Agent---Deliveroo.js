...
async function applyAction(parentState: SimulationState, desire: IDesire, costEstimator: CostEstimator, scorer: FuzzyDesirabilityScorer): Promise<SimulationState> {
    ...
    const stepReward = scorer.score({...evaluation, estimatedCost});
