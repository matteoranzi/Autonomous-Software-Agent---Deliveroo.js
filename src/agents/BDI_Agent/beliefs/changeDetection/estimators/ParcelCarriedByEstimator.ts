import {DeliberationContext, IChangeDetectionEstimator, ParcelVanishReason, StrategyResult} from "@/agents/BDI_Agent/beliefs/changeDetection/IChangeDetectionStrategy";
